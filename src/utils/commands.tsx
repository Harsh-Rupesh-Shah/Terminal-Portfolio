    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          ...
          <ul className="list-disc list-inside space-y-1 ml-2">
            <li>resume generate - Generate resume with selected template</li>
            <li>resume preview - Preview current resume</li>
            <li>resume template - List available templates</li>
            <li>resume download - Download resume as PDF</li>
          </ul>
        </div>
        ...
        <div className="space-y-2">
          ...
          <ul className="list-disc list-inside space-y-1 ml-2">
            ...
            <li>sudo hire_me - View my resume</li>
          </ul>
        </div>
      </div>
...
const getAIResponse = (question: string): string => {
  const responses = {
    experience: "I have extensive experience in full-stack development, with a focus on React and Node.js. I've worked on various projects ranging from e-commerce platforms to real-time analytics dashboards.",
    skills: "My core skills include React, TypeScript, Node.js, and AWS. I'm also experienced with Docker, CI/CD, and various testing frameworks.",
    education: "I hold a Master's degree in Computer Science with a specialization in AI and Machine Learning.",
    default: "I'd be happy to tell you more about my experience and skills. Feel free to ask specific questions!",
  };

  if (question.toLowerCase().includes('experience')) return responses.experience;
  if (question.toLowerCase().includes('skills')) return responses.skills;
  if (question.toLowerCase().includes('education')) return responses.education;
